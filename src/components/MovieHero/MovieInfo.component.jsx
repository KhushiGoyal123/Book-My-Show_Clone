...
const MovieInfo = () => {
    ...
    // optional chaining technique is used above
          ...
          <PaymentModal setIsOpen={setIsOpen} isOpen={isOpen} price={price} />
            <div className="flex flex-col gap-3 lg:gap-8"> 
                ...
                <div className="flex items-center gap-3 md:px-4 md:w-screen lg:w-full">
                    <button onClick={rentMovies} className="bg-red-400 w-full py-3 text-white font-semibold rounded-lg">
                        Rent ₹149
                    </button>
                    <button onClick={buyMovies} className="bg-red-400 w-full py-3 text-white font-semibold rounded-lg">
                       Buy ₹599
                    </button>
                </div>
                </div>
